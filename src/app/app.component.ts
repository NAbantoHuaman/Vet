          ...
          <div class="flex items-center justify-between h-20">
            ...
            <div class="hidden md:flex space-x-2 bg-gray-100/50 p-1.5 rounded-2xl items-center">
              ...
              @if(auth.isAdmin()) {
                ...
                <button (click)="navigate('admin-appointments')" [class]="navClass('admin-appointments')">Gestión Citas</button>
              ...
              @if(auth.isClient()) {
                ...
                <button (click)="navigate('client-appointments')" [class]="navClass('client-appointments')">Mis Citas</button>
          ...
          @if(mobileMenuOpen()) {
            <div class="md:hidden py-4 border-t border-gray-100 space-y-2 animate-fade-in">
              ...
              @if(auth.isAdmin()) {
                ...
                <button (click)="navigate('admin-appointments')" class="w-full text-left px-4 py-3 rounded-xl font-medium" [class]="navClass('admin-appointments')">Gestión Citas</button>
              ...
              @if(auth.isClient()) {
                ...
                <button (click)="navigate('client-appointments')" class="w-full text-left px-4 py-3 rounded-xl font-medium" [class]="navClass('client-appointments')">Mis Citas</button>
